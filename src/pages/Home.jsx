...
const Home = () => {
	...
	// fetchWeather();
	return (
		<div className='bg-[#201f1f] text-blue-100 py-40 px-24  max-[734px]:px-0 justify-center flex '>
		{/* <div className='bg-[#000a18] text-blue-100 py-40 px-24  max-[734px]:px-0 justify-center flex '> */}
			<div className=' flex-col  flex  max-w-[2300px]'>
				<div className='bg-gradient-to-b from-[#15bff7]  to-[#62eac6] max-[934px]:h-[560px] weather_box shadow-[0_35px_60px_-15px_rgba(0,205,231,0.3)] mb-10 w-full'>
